...
import { Mail, Lock, User, Eye, EyeOff, Sparkles, ArrowRight, CheckCircle, School } from 'lucide-react';
import { motion } from 'framer-motion';
import { useForm } from 'react-hook-form';
import { zodResolver } from '@hookform/resolvers/zod';
import { z } from 'zod';
import { Button, Input, Select, Card } from '@it-master-ai/ui';
        ...
        <div className="relative flex flex-col items-center justify-center min-h-screen px-4 py-12">
          ...
          <Card className="w-full max-w-md">
            <Card.Header className="text-center">
              ...
              <Card.Description>Join thousands of students learning IT with AI</Card.Description>
            </Card.Header>
            ...
            <Card.Content className="space-y-5">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                >
                  <Select.Trigger><Select.Value placeholder="Select your grade" /></Select.Trigger>
                  <Select.Content>
                    {grades.map(g => <Select.Item key={g.value} value={g.value}>{g.label}</Select.Item>)}
                  </Select.Content>
                </Select>
          ...
          <p className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400 max-w-md">
            By creating an account, you agree to our <Link to="#" className="underline hover:text-primary-600">Terms of Service</Link> and <Link to="#" className="underline hover:text-primary-600">Privacy Policy</Link>.
          </p>
        </div>
      </motion.div>
    </div>
