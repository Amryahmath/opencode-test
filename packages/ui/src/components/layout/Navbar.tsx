...
import { Menu, X, Sun, Moon, Monitor, LogIn, User, LayoutDashboard, BookOpen, Bot, HelpCircle, ChevronDown, Sparkles, CheckCircle, Shield, Zap, Award, Users, ArrowRight } from 'lucide-react';
            ...
            <div className="relative">
              ...
              <AnimatePresence>
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 top-full mt-2 w-40 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50"
                >
                ...
                <AnimatePresence>
                  {isProfileOpen && (
                    <motion.div
                      ...
                      className="absolute right-0 top-full mt-2 w-56 origin-top-right rounded-xl bg-white py-2 shadow-lg ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700"
                      role="menu"
                    >
            ...
            >
              <div className="px-4 py-4 space-y-2">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700 flex flex-col gap-3">
                  {!isAuthenticated ? (
                    <>
                      <Link to="/login" onClick={() => setIsMobileMenuOpen(false)} className="w-full text-center px-4 py-2.5 rounded-lg text-base font-medium text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800">
                        Sign In
                      </Link>
                    ...
                    <>
                      <Link to="/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-base font-medium text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800">
                        <LayoutDashboard className="h-5 w-5" />
                        Dashboard
                      </Link>
                      <Link to="/profile" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-base font-medium text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800">
                        <User className="h-5 w-5" />
                        Profile
                      </Link>
                      <button
                        onClick={() => { logout(); setIsMobileMenuOpen(false); }}
                        className="flex w-full items-center gap-3 px-3 py-2.5 rounded-lg text-base font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20"
                      >
